...
var sendForm = document.querySelector('#chatform'),
    ...
    previousInput,
    isReaction = false,
    BOTCommReaction = "I didn't quite get that.",
...
var checkInput = function(input) {
  ...
  for(var textVal in possibleInput){
    ...
    if(input == "no" && previousInput == textVal){
      BOTCommReaction = "For a list of commands type: Commands";
      //ChatGPTCommand("I'm sorry to hear that :(")
...
function putJson(input){


  //var url = "./static/datasets/index.json"
  var url = "http://127.0.0.1:5000/openai/"
  ...
  request.onload = function (e) {
    ...
    request.send(JSON.stringify({"content":[input]})); 

  
    return BOTCommReaction;
  }
...
function ChatGPTCommand(BOTCommReaction) {
  // animationCounter = 1;
  ...
  failedResponse.innerHTML = BOTCommReaction; //adds input of textarea to chatbubble list item
...
var reactionInput = {
  "best work" : function(){
    ...
    responseText("On this GitHub page you'll find everything about ChatGPT");
    responseText("<a href='https://github.com/vvhanxing/ChatGPTAPP'>ChatGPT on GitHub</a>")
    animationCounter = 1;
    return
  },
  "about" : function(){
    responseText("ChatGPT3.5");
    animationCounter = 1;
    return
    }
}